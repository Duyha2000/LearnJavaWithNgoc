...
public class Main {
  public static void main(String[] args) {
    ...
    // Bài tập: nhập 1 số từ 1 đến n, in ra số đầu tiên chia hết cả 3 và 5. Ví dụ: n
    // = 43 -> Output: 15
  }
...
// Nhập vào hai số nguyên dương a và b. Sử dụng vòng lặp for để tìm ước số chung
...
// }
// }
// // Bài tập 4: nhập vào 1 số và in ra các số từ 1 đến n (trừ số 3). Ví dụ nhập
// n
// // = 7 -> in ra 1 2 4 5 6 7
...
// Bài tập 5: Hãy đếm số lượng các số lẻ không chia hết cho 5 và không chia hết
// cho 7 nằm trong
...
// không in ra trong vòng lặp for trong đa số trường hợp (vì sẽ bị in nhiều lần)
...
// for từ 1 đến số đấy, number chia hết cho số nào từ 1 đến số đấy thì nó chính
// là ước số
...
// System.out.println(multiply);
// Output: 2 ^ 3 = 8 (2 * 2 * 2)
// lặp đi lặp lại 1 hành động nhân các số 2 vào với nhau, số lần lặp phụ thuộc
// vào b
